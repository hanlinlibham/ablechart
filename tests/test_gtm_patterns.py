...
from pptchartengine import normalize_spec, render_chart
...
def test_gtm_theme_available():
    from pptchartengine import COLOR_SCHEMES
...
class TestCapabilityLowering:
    ...
    def test_average_without_value_or_series_is_error(self):
        from pptchartengine import SpecError
...
class TestProfessionalPolishRound:
    ...
    def test_range_sort_desc_by_current(self):
        ...
        prs, slide = _slide()
        from pptchartengine import create_range_chart
    ...
    def test_year_abbrev_format(self):
        from pptchartengine.polish import strftime_from_excel
        assert strftime_from_excel("'yy") == "'%y"

    def test_nice_ladder_15_and_3(self):
        from pptchartengine.polish import nice_range
